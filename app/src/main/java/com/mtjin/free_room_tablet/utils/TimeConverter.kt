...
fun String.convertFullDateToTimestamp(): Long =
    SimpleDateFormat("yyyy-MM-dd-HH:mm", Locale.KOREA).parse(this).time

fun Long.convertTimestampToFullDate(): String =
...
// 현재 타임스탬프를 date만 포함한 타임스탬프로 변환
fun Long.convertDateTimestamp(): Long = this.convertTimestampToDate().convertDateToTimestamp()
